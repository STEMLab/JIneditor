...
public class IndoorCoordinateGenerater {
	...
	public IndoorCoordinateGenerater(IndoorFeatures indoorFeatures, boolean is3DGeometry) {
	...
	public void traversePrimalSpaceFeatures(PrimalSpaceFeatures primalSpaceFeatures) {		
		...
		for(CCTVOnFloor cctvOnFloor : cctvOnFloors) {
			traverseCCTVOnFloor(cctvOnFloor);
		}
	}
	...
	public void traverseCCTVOnFloor(CCTVOnFloor cctvOnFloor) {
	...
	public void traverseCCTV(CCTV cctv) {
		generatePointCoordinate(cctv.getLocation());
	}
